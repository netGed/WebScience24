...
train_cleaned_rnn.csv todo
- train.csv in bereinigter Form (alle Bereinigungs- und Vorverarbeitungsschritte AUßER: )
...
predict_cleaned_rnn.csv todo
- predict.csv in bereinigter Form (alle Bereinigungs- und Vorverarbeitungsschritte AUßER: )